...
async function setup() {
  ...
  if (!url) {
    ...
    console.log("Please add LIBSQL_DB_URL and LIBSQL_DB_AUTH_TOKEN to your .env file to run this script.");
    process.exit(1);
  }
  ...
  try {
    ...
    await client.execute(`
      CREATE TABLE IF NOT EXISTS registrations (
        ...
        id_proof_url TEXT,            -- Storing raw Base64 data URL
        medical_conditions TEXT,
        payment_receipt_url TEXT,     -- Storing raw Base64 data URL
        created_at TEXT DEFAULT (datetime('now'))
      );
    `);
    console.log("Database table 'registrations' verified successfully!");
  } catch (error) {
